        ...
        <div className="grid-1-1 height50 padding-left-50 padding-right-50">
          <div className="grid-1-1 grid-flex height80 border-bottom-header">
            ...
            <div className="display-flex">
              ...
              <div className="width80 labelColorWhite label-size-16 margin-right-20 label-weight-normal hover-label cursor-pointer">
                <Link href="/encriptar">Encriptar</Link>
              </div>
              ...
              <div id="dados">
                <div className="grid-1-1 borderWhite height200 border-radius-15 padding10 margin-top-20">
                  <textarea
                    ...
                    placeholder="Escreva os dados para encriptar"></textarea>
                </div>
                <div
                  ...
                  <div className="grid-1-1">
                    <div className="grid-1-1 height200 height-reset border-radius-15 borderWhite padding10">
                      <textarea
                        ...
                        rows="30"
                        className="grid-1-1 border-none height-100-percent inputText resize-none labelColorWhite"
                        placeholder="O seu documento"></textarea>
                    </div>
                    <div
                      className="width300 height20 border-radius-15 colorRed padding10 margin-top-20 buttonHover"
                      onClick={encryptFile}>
