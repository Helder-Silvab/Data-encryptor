        ...
        <div className="grid-1-1 height50 padding-left-50 padding-right-50">
            <div className="grid-1-1 grid-flex height80 border-bottom-header">
                ...
                <div className="display-flex">
                    <div className="width60 labelColorWhite label-size-16 margin-right-20 label-weight-normal hover-label cursor-pointer"><a href="/">Home</a></div>
                    <div className="width80 labelColorWhite label-size-16 margin-right-20 hover-label cursor-pointer"><a href="encriptar">Encriptar</a></div>
        ...
        <div className="content over-flow-auto padding-left-50 padding-right-50">
            <div className="grid-1-1 grid-flex margin-top-80">
                <div className="width700">
                    <div className="label-size-40 labelColorGradient label-weight-bold">A codeShield ira encriptar os seus  dados com a maior segurança possivel</div>
                </div>
                <div className="grid-flex-grow"></div>
            </div>
            <div className="grid-1-1 grid-flex margin-top-80">
                <div className="grid-1-1">
                    <div className="grid-1-1 label-size-18 labelColorWhite label-weight-normal">O que fazemos?</div>
                    <div className="width330 label-size-16 labelColorWhite margin-top-20">Encriptamos e desencriptamos <span className="labelColorRed label-weight-normal">dados, ficheiros e imagens</span> para conseguir aumentar a sua <span className="labelColorYellow label-weight-normal">segurança</span></div>
                </div>
                <div className="grid-1-1">
                    <div className="width230 height180 height-reset colorAzulEscuro border-radius-20 padding20 card">
                        ...
                        <div className="grid-1-1 label-size-18 labelColorWhite label-weight-normal align-center margin-top-40">Dados</div>
                        <div className="grid-1-1 label-size-16 labelColorGray align-center margin-top-20">Encripte os seus dados sensiveis</div>
                    </div>
                </div>
                <div className="grid-1-1">
                    <div className="width230 height180 height-reset colorAzulEscuro border-radius-20 padding20">
                        ...
                        <div className="grid-1-1 label-size-18 labelColorWhite label-weight-normal align-center margin-top-40">Ficheiros</div>
                        <div className="grid-1-1 label-size-16 labelColorGray align-center margin-top-20">Encripte os seus ficheiros importantes</div>
                    </div>
                </div>
                <div className="grid-1-1">
                    <div className="width230 height180 height-reset colorAzulEscuro border-radius-20 padding20">
                        <div className="icon-img-card icon-size-70 width70 height70 position-absolute card-image"></div>
                        <div className="grid-1-1 label-size-18 labelColorWhite label-weight-normal align-center margin-top-40">Imagens</div>
                        <div className="grid-1-1 label-size-16 labelColorGray align-center margin-top-20">Encripte as suas imagens signficantes</div>
                    </div>
                </div>
            ...
            <div className="grid-1-2 height-100-percent margin-auto">
                <div className="grid-1-1 grid-flex border-top-footer">
                   <div className="grid-1-1 grid-flex margin-top-20">
                        ...
                        <div className="display-flex">
                            <div className="width60 labelColorWhite label-size-16 margin-right-20 label-weight-normal hover-label cursor-pointer"><a href="/">Home</a></div>
                            <div className="width80 labelColorWhite label-size-16 margin-right-20 hover-labe cursor-pointerl"><a href="encriptar">Encriptar</a></div>
                            <div className="width100 labelColorWhite label-size-16 margin-right-20 hover-label cursor-pointer">Desencriptar</div>
                        </div>
                        <div className="grid-flex-grow"></div>
                   </div>
