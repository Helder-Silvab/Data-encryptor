          ...
          <div className="grid-1-1 grid-flex height80">
            ...
            <div className="display-flex width300">
              <div className="grid-1-1 grid-flex height50 colorWhite border-radius-50 margin-top-15">
                <div className="grid-1-2 labelColorWhite label-weight-normal label-size-16 colorGradient padding-left-10 border-radius-50 align-center cursor-pointer">
                  <Link to="/login">Login</Link>
                </div>
                <div className="grid-1-2 labelColorBlack label-weight-normal label-size-16 align-center padding-right-10 cursor-pointer">
